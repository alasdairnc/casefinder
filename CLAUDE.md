...
- [x] Alberta statutes in civil law database + jurisdiction grouping in Results (Federal / ON / BC / AB)
- [x] Suggested links panel — CanLII search terms and direct statute links generated by Claude (`SuggestionLink.jsx`)
