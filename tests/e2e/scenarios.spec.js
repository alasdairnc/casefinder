...
const IMPAIRED_DRIVING_RESPONSE = {
  ...
  case_law: [
    {
      ...
      title: "R v Stellato",
      summary:
        "Established the slight degree of impairment test for over 80 offences.",
      court: "SCC",
      year: "1994",
      matched_content:
        "Slight impairment is sufficient for conviction under the impaired driving provisions.",
    },
  ],
  civil_law: [],
  charter: [
    {
      ...
      summary:
        "Warrantless breath demands must be supported by reasonable grounds.",
    },
    {
      citation: "s. 9",
  ...
  suggestions: [
    {
      type: "canlii",
      label: "impaired driving BAC over 80",
      term: "impaired driving BAC over 80",
    },
  ],
};
...
test.describe("Scenario: Impaired Driving", () => {
  ...
  test("shows Criminal Code section for over-80 offence", async ({ page }) => {
    await submitScenario(
      page,
      "Driver pulled over with BAC of 0.12 after refusing a roadside test",
    );
    await expect(
      page.getByText(
        "Operating a conveyance with a BAC over 80 mg per 100 mL.",
      ),
    ).toBeVisible();
    await expect(
      page.getByText("Refusing a breathalyzer demand is itself an offence."),
    ).toBeVisible();
  });
  ...
  test("shows Charter rights section", async ({ page }) => {
    ...
    await expect(
      page.getByText("A traffic stop must not constitute arbitrary detention."),
    ).toBeVisible();
  });
  ...
  test("shows verified case law citation", async ({ page }) => {
    ...
    await expect(
      page.getByText("R v Stellato, 1994 CanLII 94 (SCC)"),
    ).toBeVisible();
    await expect(
...
const ASSAULT_RESPONSE = {
  ...
  case_law: [
    {
      ...
      title: "R v McCraw",
      summary:
        "Defined bodily harm as hurt or injury that interferes with health or comfort.",
      court: "SCC",
      year: "1991",
      matched_content:
        "Bodily harm must be more than merely transient or trifling.",
    },
  ],
  civil_law: [],
  charter: [],
  ...
  suggestions: [
    {
      type: "canlii",
      label: "assault bodily harm sentencing",
      term: "assault bodily harm sentencing",
    },
...
test.describe("Scenario: Assault Causing Bodily Harm", () => {
  ...
  test("shows assault causing bodily harm section", async ({ page }) => {
    ...
    await expect(
      page.getByText("Assault that causes bodily harm to the complainant."),
    ).toBeVisible();
    await expect(
      page.getByText("Intentional application of force without consent."),
    ).toBeVisible();
  });
...
const DRUG_TRAFFICKING_RESPONSE = {
  ...
  case_law: [
    {
      ...
      year: "2020",
      matched_content:
        "Controlled drug purchases are a common investigative technique for mid-level trafficking.",
    },
  ],
  civil_law: [
    {
      ...
      summary:
        "Trafficking in a substance listed in Schedule I (cocaine) is an indictable offence.",
      act: "CDSA",
    },
    {
      ...
      summary:
        "Maximum life imprisonment for trafficking in a Schedule I substance.",
      act: "CDSA",
    },
  ],
  charter: [
    {
      ...
      title: "Search and Seizure",
      summary:
        "Residential search requires a warrant. Evidence at residence may be challenged.",
    },
  ],
  analysis:
  ...
  suggestions: [
    {
      type: "canlii",
      label: "cocaine trafficking sentencing",
      term: "cocaine trafficking sentencing",
    },
  ],
};
...
test.describe("Scenario: Drug Trafficking (CDSA)", () => {
  ...
  test("shows CDSA civil law sections", async ({ page }) => {
    await submitScenario(
      page,
      "Accused sold cocaine to an undercover officer and had more drugs at home",
    );
    await expect(
      page.getByText(
        "Trafficking in a substance listed in Schedule I (cocaine) is an indictable offence.",
...
const SEXUAL_ASSAULT_RESPONSE = {
  ...
  criminal_code: [
    ...
    },
    {
      ...
      summary:
        "Rape shield provisions restricting use of prior sexual history.",
    },
  ],
  case_law: [
    {
      ...
      year: "1999",
      matched_content:
        "Consent must be communicated; silence or ambiguity does not constitute consent.",
    },
  ],
  civil_law: [],
  charter: [
    {
      ...
      summary:
        "Accused right to full answer and defence must be balanced against complainant privacy rights.",
    },
  ],
  analysis:
  ...
  suggestions: [
    {
      type: "canlii",
      label: "sexual assault consent intoxication",
      term: "sexual assault consent intoxication",
    },
  ],
};
...
test.describe("Scenario: Sexual Assault", () => {
  test.beforeEach(async ({ page }) => {
    await mockApis(
      page,
      SEXUAL_ASSAULT_RESPONSE,
      SEXUAL_ASSAULT_VERIFY_RESPONSE,
    );
  });
  ...
  test("shows sexual assault and consent sections", async ({ page }) => {
    await submitScenario(
      page,
      "Accused touched the complainant sexually at a party without consent",
    );
    await expect(
      page.getByText("Assault of a sexual nature committed without consent."),
    ).toBeVisible();
    await expect(
      page.getByText(
        "Consent means voluntary agreement to engage in sexual activity.",
  ...
  test("shows Ewanchuk case verified", async ({ page }) => {
    ...
    await expect(
      page.getByText("R v Ewanchuk, 1999 CanLII 711 (SCC)"),
    ).toBeVisible();
    await expect(
      page.getByRole("link", { name: /Verified on CanLII/i }),
    ).toBeVisible();
...
const FRAUD_RESPONSE = {
  ...
  criminal_code: [
    {
      ...
      summary:
        "Defrauding the public or any person of property, money, or services valued over $5,000.",
    },
    {
      citation: "s. 380.1",
      title: "Aggravating Factors — Fraud",
      summary:
        "Sentencing aggravating factors including large number of victims and sophistication.",
    },
  ],
  case_law: [
    {
      ...
      title: "R v Theroux",
      summary:
        "Defined the mental element for fraud: subjective knowledge of the prohibited act and risk of deprivation.",
      court: "SCC",
      year: "1993",
      matched_content:
        "Fraud requires proof of dishonest act and subjective awareness of deprivation risk.",
    },
  ],
  civil_law: [],
  charter: [],
  ...
  suggestions: [
    {
      type: "canlii",
      label: "fraud investment sentencing",
      term: "fraud investment sentencing",
    },
...
test.describe("Scenario: Fraud Over $5,000", () => {
  ...
  test("shows fraud over $5,000 section", async ({ page }) => {
    await submitScenario(
      page,
      "Accused ran a fake investment scheme collecting $200,000 from victims",
    );
    await expect(
      page.getByText(
        "Defrauding the public or any person of property, money, or services valued over $5,000.",
  ...
  test("shows Theroux verified and analysis mentions Ponzi", async ({
    page,
  }) => {
    await submitScenario(
      page,
    ...
    await expect(
      page.getByText("R v Theroux, 1993 CanLII 134 (SCC)"),
    ).toBeVisible();
...
const YCJA_RESPONSE = {
  ...
  civil_law: [
    {
      ...
      summary:
        "Extrajudicial measures are presumed adequate for first-time non-violent offences by youth.",
      act: "YCJA",
    },
    {
      citation: "YCJA s. 38",
      ...
      summary:
        "Youth sentencing focuses on rehabilitation and reintegration, not deterrence and denunciation.",
      act: "YCJA",
    },
  ],
  charter: [],
  ...
  suggestions: [
    {
      type: "canlii",
      label: "youth extrajudicial measures shoplifting",
      term: "youth extrajudicial measures shoplifting",
    },
  ],
};
...
test.describe("Scenario: Youth Offender (YCJA)", () => {
  ...
  test("shows YCJA extrajudicial measures and sentencing purpose", async ({
    page,
  }) => {
    await submitScenario(
      page,
  ...
  test("shows underlying CC theft section alongside YCJA", async ({ page }) => {
    ...
    await expect(
      page.getByText("Theft of property valued under $5,000."),
    ).toBeVisible();
